...
import com.pinkladydev.DartsRestAPI.helpers.GenerateMany;
...
class UserControllerTest {
    ...
    void getUsers_shouldReturnWithOk_andReturnAllUsers() throws Exception {
        ...
        final List<User> users = GenerateMany.generateListOf(ChanceUser::randomUser, getRandomNumberBetween(2,4));
